...
export const metadata: Metadata = {
  title: 'Велиж',
  description:
    'База отдыха Велиж — это идеальное место для отдыха в горах с комфортабельными домиками, живописными видами, пешими прогулками и активными развлечениями на свежем воздухе. Забронируйте ваш отдых уже сегодня!',
};
